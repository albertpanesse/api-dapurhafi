...
func (dbconn *DBConn) GetProduct(c *gin.Context) {
	...
	dbconn.DB.Preload("ProductPicts").Preload("Category").First(&product, id)
...
func (dbconn *DBConn) GetProducts(c *gin.Context) {
	...
	dbconn.DB.Preload("ProductPicts").Preload("Category").Find(&products)
...
func (dbconn *DBConn) GetLatest(c *gin.Context) {
	...
	dbconn.DB.Preload("ProductPicts").Preload("Category").Limit(10).Find(&products).Order("updated_at desc")
...
func (dbconn *DBConn) ProductSearch(c *gin.Context) {
	...
	chain.Preload("ProductPicts").Preload("Category").Find(&products)
